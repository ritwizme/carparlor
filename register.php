...
<div id="popup-bg">
	<div id="popup_main_div">
		...
		Email:    <input type="text" name="email"  value="enter name" id="f_name_input"/>
		<br/><br />
...
<div id="popup-bg2">
    ...
    <form id="login_f3" action="user1.php" method="POST">
		Full Name: <input type="text" name="name"   placeholder="Full Name" id="user_n_input"/>
		<br/><br />
        Email Id: <input type="text" name="email"  placeholder="Email ID" id="user_e_input"/>
		<br/><br />
        
        Contact No: <input type="text" name="city"   placeholder="Contact No" id="user_contact_input"/>
		<br/><br />
        Date of Birth:<br /> <input type="text" name="contact"  placeholder="Date of Birth" id="user_dob_input"/>
		<br/><br />
